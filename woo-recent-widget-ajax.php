...
Copyright: © 2017-2020 Pino Ceniccola
...
add_action( 'wp_enqueue_scripts', function() {
	wp_enqueue_script( 'recently-viewed', plugins_url('js/recentlyViewed.min.js', __FILE__), array('jquery'), '0.2.0', true );

	// Since 0.2.0: ajaxurl and cookiepath now are delivered with wp_localize_script
	wp_localize_script( 'recently-viewed', 'recently_viewed_object',
		array( 
...
function wpe_extend_recently_viewed_widget() {
	...
	public function widget( $args, $instance ) {
		...
		$content = str_replace('id="woocommerce_recently_viewed','style="display:none !important" data-number="'.$number.'" id="woocommerce_recently_viewed', $content);
		echo $content;
	}
	}
